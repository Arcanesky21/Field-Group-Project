...
<head>
	...
	<?php require_once "../Field-Group-Project/database/dbconnect.php" ?>
</head>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<section class="hero-wrap js-fullheight" style="background-image: url('../Field-Group-Project/images/BuildingNCU.jpeg');" data-section="home" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-5 d-flex">
					<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
						<form action="#" class="appointment-form ftco-animate">
							...
							<div class="">
								<div class="form-group">
									<textarea name="" id="" cols="30" rows="2" class="form-control" placeholder="Message - 200 word limit" maxlength="200"></textarea>
								</div>
								<div class="form-group">
		...
		<div class="container-fluid px-5">
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(../Field-Group-Project/images/jdcoc1.jpg);"></div>
						</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(../Field-Group-Project/images/jdoc2.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(../Field-Group-Project/images/jdoc3.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(../Field-Group-Project/images/jdoc4.jpg);"></div>
						</div>
						<div class="text pt-3 text-center">
